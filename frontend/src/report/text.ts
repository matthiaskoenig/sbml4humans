...
/** The characters a column of a nested table needs: its longest text or its header, whichever is
 * longer, up to MAX_COLUMN_CHARS. The tables of one element which stand under each other take the
 * widths of their columns from all of their rows together, so that a column lines up with the
 * same column of the table above it. */
