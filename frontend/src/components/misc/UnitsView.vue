...
/** Null for a missing unit and a units attribute `dimensionless` (the report's "-" placeholder),
 * and for a unit whose latex is too long to render or that KaTeX throws on: the placeholder of
 * an empty cell shows in every one of these cases, never a KaTeX minus or a blank cell. */
