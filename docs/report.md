...
The reference page of a type lists its columns with the meaning of each of them, and hovering a column header shows that meaning as one sentence.
...
![The annotations column of a species, with two of its resources resolved to their names](images/inspector-annotations.png)
