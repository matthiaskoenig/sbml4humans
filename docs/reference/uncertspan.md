...
| --- | --- | --- | --- | --- |
| [valueLower](#valuelower) | [`double`](datatypes.md#double) | - | the lower end of the interval as a number | [distrib 3.12](https://sbml.org/specifications/sbml-level-3/version-1/distrib/version-1/release-1/sbml-level-3-version-1-distrib-version-1-release-1.pdf) |
| [valueUpper](#valueupper) | [`double`](datatypes.md#double) | - | the upper end of the interval as a number | [distrib 3.12](https://sbml.org/specifications/sbml-level-3/version-1/distrib/version-1/release-1/sbml-level-3-version-1-distrib-version-1-release-1.pdf) |
| [varLower](#varlower) | [`SIdRef`](datatypes.md#sidref) | - | the element of the model which holds the lower end | [distrib 3.12](https://sbml.org/specifications/sbml-level-3/version-1/distrib/version-1/release-1/sbml-level-3-version-1-distrib-version-1-release-1.pdf) |
| [varUpper](#varupper) | [`SIdRef`](datatypes.md#sidref) | - | the element of the model which holds the upper end | [distrib 3.12](https://sbml.org/specifications/sbml-level-3/version-1/distrib/version-1/release-1/sbml-level-3-version-1-distrib-version-1-release-1.pdf) |
...
| [units](#units) | [`UnitSIdRef`](datatypes.md#unitsidref) | - | the units both ends of the interval are given in | [distrib 3.12](https://sbml.org/specifications/sbml-level-3/version-1/distrib/version-1/release-1/sbml-level-3-version-1-distrib-version-1-release-1.pdf) |
| [value](#value) | [`double`](datatypes.md#double) | - | the single number of a measure, which a span does not use | [distrib 3.11.2](https://sbml.org/specifications/sbml-level-3/version-1/distrib/version-1/release-1/sbml-level-3-version-1-distrib-version-1-release-1.pdf) |
| [var](#var) | [`SIdRef`](datatypes.md#sidref) | - | the element of a single number, which a span does not use | [distrib 3.11.2](https://sbml.org/specifications/sbml-level-3/version-1/distrib/version-1/release-1/sbml-level-3-version-1-distrib-version-1-release-1.pdf) |
| [definitionURL](#definitionurl) | [`anyURI`](datatypes.md#anyuri) | - | what an external parameter which is an interval means | [distrib 3.11.4](https://sbml.org/specifications/sbml-level-3/version-1/distrib/version-1/release-1/sbml-level-3-version-1-distrib-version-1-release-1.pdf) |
| [math](#math) | [`Math`](datatypes.md#math) | - | the formula of an external parameter which is an interval | [distrib 3.11.6](https://sbml.org/specifications/sbml-level-3/version-1/distrib/version-1/release-1/sbml-level-3-version-1-distrib-version-1-release-1.pdf) |
| [uncertParameters](#uncertparameters) | [`list`](datatypes.md#list) | - | the parameters which define an external parameter | [distrib 3.11.7](https://sbml.org/specifications/sbml-level-3/version-1/distrib/version-1/release-1/sbml-level-3-version-1-distrib-version-1-release-1.pdf) |
