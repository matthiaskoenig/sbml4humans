...
| --- | --- | --- | --- | --- |
| [math](#math) | [`Math`](datatypes.md#math) | - | the condition which has to stay true | [core 4.10.1](https://sbml.org/documents/specifications/level-3/version-2/core/) |
| [message](#message) | [`XHTML`](datatypes.md#xhtml) | - | the text which is shown when the condition is violated | [core 4.10.2](https://sbml.org/documents/specifications/level-3/version-2/core/) |
