...
[SBML Level 3 Package: Flux Balance Constraints (fbc)](https://sbml.org/documents/specifications/level-3/version-1/fbc/) (Olivier et al. 2026, Version 3 Release 1).
