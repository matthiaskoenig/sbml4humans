...
| --- | --- | --- | --- | --- |
| [geneProduct](#geneproduct) | [`SIdRef`](datatypes.md#sidref) | - | the gene product this leaf of the association names | [fbc v3 3.11](https://identifiers.org/combine.specifications/sbml.level-3.version-1.fbc.version-3.release-1) |
