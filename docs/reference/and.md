...
| --- | --- | --- | --- | --- |
| [associations](#associations) | [`list`](datatypes.md#list) | - | the nodes which are all needed, two or more of them | [fbc v3 3.12](https://identifiers.org/combine.specifications/sbml.level-3.version-1.fbc.version-3.release-1) |
