...
An output names the [qualitative species](qualitativespecies.md) whose level a [transition](transition.md) changes. Its [transition effect](output.md#transition-effect) is what tells the two formalisms of the package apart: `assignmentLevel` for a logical model, `production` for a Petri net.
...
| --- | --- | --- | --- |
| [qualitative species](#qualitative-species) | `SIdRef` | the species whose level the transition changes | [qual 3.6.2](https://sbml.org/documents/specifications/level-3/version-1/qual/) |
| [output level](#output-level) | `integer` | the level the transition produces per result level | [qual 3.6.2](https://sbml.org/documents/specifications/level-3/version-1/qual/) |
| [transition effect](#transition-effect) | `transitionOutputEffect` | whether the transition sets the level of the species or adds to it | [qual 3.6.2](https://sbml.org/documents/specifications/level-3/version-1/qual/) |
...
<span id="output-level"></span>**output level**
