...
| --- | --- | --- | --- | --- |
| [math](#math) | [`Math`](datatypes.md#math) | - | the condition whose change from false to true fires the event | [core 4.12.2](https://sbml.org/documents/specifications/level-3/version-2/core/) |
