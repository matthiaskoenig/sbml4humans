...
| --- | --- | --- | --- | --- |
| [variable](#variable) | [`SIdRef`](datatypes.md#sidref) | - | the element the rule assigns to | [core 4.9.3](https://sbml.org/documents/specifications/level-3/version-2/core/) |
| [math](#math) | [`Math`](datatypes.md#math) | - | the formula which computes the value of the variable | [core 4.9.1](https://sbml.org/documents/specifications/level-3/version-2/core/) |
